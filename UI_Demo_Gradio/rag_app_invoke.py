...
def chatbot(user_input, history=[]):
    ...
    response_nodes = index.query(user_input, similarity_top_k=3)  # get top 3 related nodes
    context_text = " ".join([node.get_text() for node in response_nodes])
    ...
    # Call Google API to generate the answer
